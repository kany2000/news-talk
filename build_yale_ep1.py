...
AUDIO_SRC = BASE / EPISODE / "耶鲁博弈论课堂的成绩陷阱.m4a"
...
TOPIC_EN_PROMPTS = [
    "Yale economics professor Ben Polak standing in front of chalkboard, teaching game theory, writing Alpha Beta, students watching from desks, clear separation between teacher and board, academic lecture, cinematic, 16:9",
    "strategic interaction, business competitors watching each other, Ford vs Toyota, market competition, interconnected decisions, cinematic, 16:9",
    "perfect competition farmers market vs monopoly single giant corporation, economic spectrum, small sellers vs one dominant company, minimal, cinematic, 16:9",
    "person looking at multiple options, confused decision making, path diverging, what do you really want, philosophical, cinematic, 16:9",
    "extremely selfish person, calculating expression, only cares about own benefit, ruthless decision, dark lighting, cinematic portrait, 16:9",
    "dominant strategy concept, highway with carpool lane, fast lane always winning, game theory visual, clear path, cinematic, 16:9",
    "prisoner's dilemma, two prisoners in separate cells, handcuffs, dilemma concept, dark moody lighting, cinematic, 16:9",
    "Pareto efficiency concept, two people both stuck in mud, visible better outcome nearby, frustration, economic theory, cinematic, 16:9",
    "dorm room with moldy bread and cheese, messy roommate, price war signs, two businesses competing, real life application, cinematic, 16:9",
    "Business contract signing, two hands shaking across desk, legal documents, binding agreement, professional attire, corporate setting, cinematic lighting, 16:9",
    "angry angel, torn between morality and self interest, guilt and anger, emotional conflict, dramatic lighting, cinematic, 16:9",
    "Empty narrow corridor, mirror reflection, two paths crossing, dilemma of choosing direction, coordination concept, minimalist photography, cinematic, 16:9",
    "Yale students in experiment, data and statistics, only 15 percent cooperate, shocking result, academic research, cinematic, 16:9",
    "poker game hidden cards, face down, information asymmetry, unknown opponent, mystery, blurred background, cinematic lighting, 16:9",
]
...
if not VIDEO_SUB.exists():
    # 复制 SRT 到无中文路径，避免 FFmpeg 路径解析问题
